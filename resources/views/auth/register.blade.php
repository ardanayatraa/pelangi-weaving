...
<head>
    ...
    <title>Daftar - Pelangi Traditional Weaving</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Buat akun baru untuk mulai belanja</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-red-600 @error('nama') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="tel" name="telepon" value="{{ old('telepon') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-red-600 @error('telepon') border-red-500 @enderror"
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-red-600 font-medium hover:text-red-700">
                        Masuk di sini
                    </a>
                </p>
            </div>
